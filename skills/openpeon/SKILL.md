---
name: openpeon
description: Control OpenPeon sounds for the current Claude Code session. Use when the user asks to switch the sound preset, change or mute the sound volume, or list available presets (peon, ogre-mage, peasant, SCV, ...).
---
